...
def filter_file(file):
    ...
    with st.container():
        ...
        if file_extension in file_processors:
            return file_processors[file_extension](file, stats_db=None)
